const roles = [
  { count: "4人", name: "美术组", summary: "视觉方向、角色概念与场景气氛", detail: "负责角色与场景概念、宣传视觉、色彩基调和最终风格统一，让不同环节的资产始终属于同一个世界。", outputs: ["角色与场景概念", "宣传视觉", "风格规范"] },
  { count: "1人", name: "程序", summary: "交互逻辑、系统接入与版本打包", detail: "负责核心玩法、关卡事件、UI接入、版本打包与技术问题排查，确保创意最终能够运行和交付。", outputs: ["核心交互", "事件系统", "版本交付"] },
  { count: "3人", name: "建模组", summary: "角色、场景模块与道具资产", detail: "负责角色、怪物、环境模块和关键道具的三维制作，并完成规范整理与引擎导入。", outputs: ["角色模型", "环境资产", "引擎规范"] },
  { count: "2人", name: "动画组", summary: "角色动作、技能反馈与关键演出", detail: "负责角色和怪物动作、技能表现、镜头演出与动画落地，让玩法反馈更清晰、角色更有生命力。", outputs: ["角色动作", "技能动画", "镜头演出"] },
  { count: "2人", name: "地编组", summary: "关卡搭建、玩家动线与光影氛围", detail: "负责关卡空间、场景摆放、光照气氛和玩家动线，把分散资产组织成可探索、可游玩的完整体验。", outputs: ["关卡空间", "光影氛围", "玩家动线"] },
  { count: "1人", name: "UI / 音效", summary: "界面反馈、声音节奏与展示包装", detail: "负责界面视觉、按钮反馈、环境音效和最终展示包装，保证信息清楚并建立统一的体验节奏。", outputs: ["界面视觉", "声音反馈", "展示包装"] }
];
...
copyButton?.addEventListener("click", async () => {
  try {
    await navigator.clipboard.writeText("xuzihao976@gmail.com");
    copyButton.textContent = "已复制";
  } catch {
    copyButton.textContent = "请手动复制";
  }
  window.setTimeout(() => copyButton.textContent = "复制邮箱", 2200);
});
